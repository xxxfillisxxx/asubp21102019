...
module.exports.models = {
  ...
  *                                                                          *
  ***************************************************************************/
  /*migrate:alter, затирает foreign key в базе mysql
  для migrate:alter:
  1) запустить скрипт для удаления foreign key foreign.sql
  1) запустить npm run dev с migrate: alter
  2) проиграть sql сценарий для добаления foreign key foreign.sql
  3) поменять migrate: safe
  */

  migrate: 'safe', // write 'drop' for clean base or write 'safe' for safe data
  ...
  ******************************************************************************/
  ...
  dataEncryptionKeys: {
    default: 'VXi8AIDHpFAiuwbe8Vxmtzp38Cdx/czmjv4g+/DfBZQ='
  },
  ...
  *                                                                          *
  ***************************************************************************/
  //для mysql не работет delete cascade, только обнуляет ключи, поэтому 
  //бесполезно, ключи прописаны физически в базе см. инструкцию выше для migrate: alter
